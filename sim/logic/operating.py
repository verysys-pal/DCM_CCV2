...
"""
Operating/state-machine logic for the simulator.

This module is intentionally lightweight. It is optional: if not loaded,
pv_bridge falls back to its internal simple state logic.
"""
